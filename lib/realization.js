...
module.exports = Realization = (function(_super) {

  __extends(Realization, _super);

  Realization.prototype.className = 'Realization';
  ...
  Realization.prototype.createFunction = function(name, opts) {
    ...
    Object.defineProperty(newFunction, 'got', {
      get: function() {
        return _this.realized["function"];
      }
    });
    if (this.object.prototype && this.object.prototype[this.name]) {
      this.prototyped = true;
      this.originalFunction = this.object.prototype[this.name];
      return this.object.prototype[this.name] = newFunction;
    } else {
  ...
  Realization.prototype.createProperty = function(name, opts) {
    ...
    return Object.defineProperty(this.object, this.name, {
      set: function(value) {
        var _base;
        (_base = _this.object)._got || (_base._got = {});
        _this.object._got[_this.name] = value;
      ...
      get: function() {
        ...
        if (opts.returns) {
          ...
          (_base = _this.object)._had || (_base._had = {});
          _this.object._had[_this.name] = _this.originalProperty;
          _this.realizeProperty({
  ...
  Realization.prototype.realizeProperty = function(args) {
    var _base;
    (_base = this.object)._had || (_base._had = {});
    return this.realized = {
      property: {
        args: this.slide(args, 1)
      }
