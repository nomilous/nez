  ...
  Coffee.prototype.watch = function(what, onchange) {
    ...
    return watcher.on('change', function(file, stats) {
      /* 
        ...
        hound defines onchange() so this didn't cause an
        undefined function exception, 

        but what surprised me is that .call with _this 
        ran the onchange as defined by _this

        until now it has been my assumption that .call
        would have run the hound.onchange but with this
        as _this

        javascript is cleverer than i thought
