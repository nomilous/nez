...
module.exports = ActiveNode = (function() {
  ...
  ActiveNode.prototype.start = function(activeConfig) {
    var match, server, service, services, type, _i, _len, _ref,
      _this = this;
    ...
    services = [];
    services.push(this.stack.stacker);
    if (type === '_realizer') {
      if (typeof this.plugin.validate !== 'undefined') {
        services.push(this.plugin.validate);
        this.stack.validate = this.plugin.validate;
      } else {
